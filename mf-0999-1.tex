...
In modern mathematics, the string of symbols $0.9999\ldots $ is understood to
be a shorthand for ``the infinite sum  $9/10 + 9/100 + 9/1000 + \ldots$''.
...
The statement that $0.9999\ldots  = 1$ is simply an abbreviation of this fact.

\[0.9999\ldots = \sum_{n=1}^{\infty}\frac{9}{10^n} =
\lim_{m\rightarrow \infty}\sum_{n=1}^m\frac{9}{10^n}\]
...
preceding proof correctly shows $0.9999\ldots = 1$.
...
\book{R.V. Churchill and J.W. Brown.}
     {Complex Variables and Applications.}
     {$5^{th}$ ed., McGraw-Hill, 1990.}

\book{E. Hewitt and K. Stromberg.}
...
\article{ F. Richman.}{ Is 0.999 = 1?,}{ Mathematics Magazine,}{ 72 (1999),
404--408.}
