...
In modern mathematics, the string of symbols $0.9999\ldots $ is understood
to be a shorthand for ``the infinite sum $9/10 + 9/100 + 9/1000 + \ldots$''.
This in turn is shorthand for ``the limit of the sequence of real numbers
$9/10$, $9/10 + 9/100$, $9/10 + 9/100 + 9/1000, \ldots$''. Using the
well-known epsilon-delta definition of the limit (you can find it in any of
the given references on analysis), one can easily show that this limit is
$1$.  The statement that $0.9999\ldots = 1$ is simply an abbreviation of
this fact.
...
the number system. After you have constructed the reals (Cauchy sequences
are well suited for this case, see [Shapiro75]), you can indeed verify that
the preceding proof correctly shows $0.9999\ldots = 1$.

An informal argument could be given by noticing that the following sequence
of ``natural'' operations has as a consequence $0.9999\ldots = 1$. Therefore
it's ``natural'' to assume $0.9999\ldots = 1$.
...
$0.46464646\ldots$ are equal to the period divided over the same number of
$9$s.  Thus $0.46464646\ldots=46/99$. Applying the same argument to
$0.9999\ldots=9/9=1$.

Although the three informal arguments might convince you that $0.9999\ldots
= 1$, they are not complete proofs. Basically, you need to prove that each
step on the way is allowed and is correct. They are also ``clumsy'' ways to
prove the equality since they go around the bush: proving $0.9999\ldots = 1$
...
then you have $0.9999\ldots = 1$ as corollary. So the rest of the argument
is irrelevant: you already proved what you wanted to prove.
