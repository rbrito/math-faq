...
% Emails and URL's:
\newcommand{\emailalopez}{\url{alopez-o@uwaterloo.ca}\xspace}
\newcommand{\emailhans}{\url{J.P.M.deVreught@hhs.nl}\xspace}
\newcommand{\emailnancy}{\url{nancym@ii.com}\xspace}
\newcommand{\emailrbrito}{\url{rbrito@ime.usp.br}\xspace}
