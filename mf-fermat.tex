...
The papers were published in the May 1995 issue of \emph{Annals of
...
\CC{
  ...
  Here is an outline of the \textbf{first, incorrect} proposed proof.
  The bits about Euler system are

  \begin{itemize}

    \item \textbf{From Ken Ribet:}
    ...
    \item \textbf{From the previous version of the FAQ:}
